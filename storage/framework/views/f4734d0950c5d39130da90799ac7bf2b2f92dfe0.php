<?php $__env->startSection('content'); ?>
    ...
    <section class="container mt-5 mb-5">
        <div class="row">
            <div class="col-7">
                <img src="<?php echo e(asset('assets/img/slider/slider1.jpg')); ?>" style="width: 100%; height: 300px; object-fit: cover">
            </div>

            <div class="col-5">
                <p style="font-size: 30px; font-weight: bold" class="mb-3">MARGO TANI FURNITURE</p>
                ...
                <p style="font-size: 14px; font-weight: bold" class="text-black-50 mb-2" >margotani@gmail.com</p>
...
<?php echo $__env->make('navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PROJECT\WEBSITE\cilikan\aji\resources\views/kontak.blade.php ENDPATH**/ ?>