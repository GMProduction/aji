    ...
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="/pimpinan/">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/pimpinan/produk">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/pimpinan/pesanan">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/pimpinan/user">
...
<?php /**PATH C:\PROJECT\WEBSITE\cilikan\aji\resources\views/pimpinan/base.blade.php ENDPATH**/ ?>